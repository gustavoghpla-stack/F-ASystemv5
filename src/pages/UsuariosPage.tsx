...
import { DB, nextId, hashPassword, isPasswordHash, syncGS, loadFromGS, type Usuario, logAcesso , onSyncComplete } from '@/lib/db';
  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        message="Este usuário será removido do sistema e da planilha Google. Esta ação não pode ser desfeita."
